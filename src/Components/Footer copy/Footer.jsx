...
const FooterDiv = styled("div")`
  height: 380px;
  background-image: url(https://s.yimg.com/ny/api/res/1.2/rNXnLchmc4VHCIH02hfd8w--/YXBwaWQ9aGlnaGxhbmRlcjt3PTY0MDtoPTM1OA--/https://media.zenfs.com/en/insidermonkey.com/64a63f085247830169a35b5b3d279198);
  flex-shrink: 0;
  margin-top: 80px;
`;
  ...
  return (
    <FooterDiv>
      <Orders>
        ...
        <Order2>
          <OrderP to={"/Golden-Steak"}>Golden-Steak</OrderP>
          <OrderP to={"/Sushi"}>Sushi</OrderP>
          <OrderP to={"/Gamburger-with-free"}>Gamburger-with-free</OrderP>
        </Order2>
        <Order2>
